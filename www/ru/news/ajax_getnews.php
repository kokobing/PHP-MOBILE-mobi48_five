...
$strSQL = "select a.title,a.id_newsinfo as id,b.lang,a.id_newsdir
		   ...
		   where a.dele=1 and b.lang=4 and b.fatherid='30'  order by a.ordernum desc limit $start,$setinfo[newsnum]" ;
