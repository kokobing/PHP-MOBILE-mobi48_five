...
if(isset($_POST[button_ok]) && $onuserperm_editprem=='1'){//修改
	...
	smailboxpass='".$_POST[smailboxpass]."',icp='".$_POST[icp]."',mapcode='".$_POST[mapcode]."',iscopy='".$_POST[iscopy]."',isstyle='".$_POST[isstyle]."',weburl='".$_POST[weburl]."',productnum='".$_POST[productnum]."',newsnum='".$_POST[newsnum]."',bannertime='".$_POST[bannertime]."' where id_siteset='1'";
...
否                                        </tr>
         ...
         <!-- <tr>
                    ...
                    <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                                    ...
                                    <tr>
                                      <td height="30" align="left" valign="top">GOOGLE<br />
                                      地图代码</td>
