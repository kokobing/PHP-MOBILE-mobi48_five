            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                    ...
                    <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                        ...
                        <tr bgcolor="#FFFFFF">
                                          ...
                                          <td bgcolor="#FFFFFF"><select name="lang" id="lang">
                                            ...
                                            <option value="2" <? if($onenewsinfo[lang]==2){echo 'selected';}?>>德语</option>
                                            <option value="3" <? if($onenewsinfo[lang]==3){echo 'selected';}?>>西班牙语</option>
                                            <option value="4" <? if($onenewsinfo[lang]==4){echo 'selected';}?>>俄语</option>
                                          </select>
                                            &nbsp;</tr>
                                                                <tr>
                    <td colspan="3" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
                        ...
                        <tr bgcolor="#FFFFFF">
                          ...
                          <? if($onenewsid=='46' || $onenewsid=='45' || $onenewsid=='44' || $onenewsid=='43' || $onenewsid=='40' || $onenewsid=='39' || $onenewsid=='38' || $onenewsid=='37' || $onenewsid=='34' || $onenewsid=='33' || $onenewsid=='32' || $onenewsid=='31' || $onenewsid=='28' || $onenewsid=='22' || $onenewsid=='23' || $onenewsid=='15' || $onenewsid=='26' || $onenewsid=='19' || $onenewsid=='2' || $onenewsid=='27'){?>  <option value="2"  <? if($onenewsinfo[location]==2){echo 'selected';}?> >显示到首页</option><? }?>
                          <? if($onenewsid!='46' && $onenewsid!='45' && $onenewsid!='44' && $onenewsid!='43' && $onenewsid!='40' && $onenewsid!='39' && $onenewsid!='38' && $onenewsid!='37' && $onenewsid!='34' && $onenewsid!='33' && $onenewsid!='32' && $onenewsid!='31' && $onenewsid!='28' && $onenewsid!='22' && $onenewsid!='23' && $onenewsid!='15' && $onenewsid!='26' && $onenewsid!='19' && $onenewsid!='2' && $onenewsid!='27'){?>  <option value="3"  <? if($onenewsinfo[location]==3){echo 'selected';}?>>显示到公司简介内页</option> <? }//排除公司简介?>
                          </select> 
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <? if($onenewsid!='2' && $onenewsid!='19' && $onenewsid!='23'  && $onenewsid!='22'  && $onenewsid!='25'  ){//排除版面内容?>
                        <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">信息内容</td>
