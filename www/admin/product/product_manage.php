...
$strSQL = "SELECT productinfo.id_prodinfo,productinfo.id_proddir,productdir.name,productinfo.title,productinfo.content,productinfo.tag,productinfo.ordernum,productdir.lang FROM productinfo left join productdir on productinfo.id_proddir=productdir.id_proddir WHERE productinfo.dele='1' $str order by productinfo.ordernum DESC" ;
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="0" >
                  ...
                  <tr>
                    ...
                    <td width="36%" align="left"><a href="product_manage.php?03<?php echo $arrproductinfos[$i][id_prodinfo]?>&searchselect=<?php echo $searchselect;?>&keywords=<?php echo $keywords;?>"  class="txt_leftmenu"><?php echo cutstr($arrproductinfos[$i][title],60,1);?></a></td>
                    <td width="10%" align="left"><?php echo $arrproductinfos[$i][tag]?></td>
...
<img src='../inc/pics/icon_0022.gif' border='0' width='10' height='10'>&nbsp;
			<? }?>              </td>
                   ...
                   <tr>
                    ...
                    <td colspan="7" align="left" valign="middle" bgcolor="#EBF3F9"  style="padding:0; height:1px;"></td>
