...
<div id="contentbox">
	  ...
	  #feedback .ui-body-a, .ui-overlay-a {color:#404040 /*{a-body-color}*/;background: transparent none;}
        ...
        <div id="feedback">
          <div class="feedbackline">姓名 *：&nbsp;&nbsp;&nbsp;&nbsp;<input id="name" type="text"  ></div>
          <div class="feedbackline">电话：&nbsp;&nbsp;&nbsp;&nbsp;<input id="tel" type="text" ></div>
          <div class="feedbackline">邮箱 *：&nbsp;&nbsp;&nbsp;&nbsp;<input id="email" type="text"  ></div>
          <div class="feedbackline">内容 *：&nbsp;&nbsp;&nbsp;&nbsp;<textarea id="content"  ></textarea></div>
          <div id="backmenu"><a onClick="sendmsg()"  href="javascript:void(0);">发送留言</a></div>
...
function sendmsg() {
						...
						$.post('/about/ajax_feedback.php',{tel:$("#tel").val(),content:$("#content").val(),name:$("#name").val(),email:$("#email").val()},function(data) {
