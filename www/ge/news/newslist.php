<?php
require "../../inc/ge_newslist_core.php";
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="abouttop"><?=$onenewsdir[name]?></div>
            ...
            <?php for($i=0;$i<sizeof($arrnews);$i++){?>
				<li><a href="/ge/news/newsview.php/<?=$ndir?>/<?=$arrnews[$i][id]?>/.html"><?=$arrnews[$i][title]?></a></li>
            <?php }?>
			</ul>
            
            <ul data-role="listview" data-inset="true" data-theme="d" data-divider-theme="d" data-count-theme="b">
            <li><a href="javascript:void(0)"  onClick="genextnews();">More <?=$onenewsdir[name]?></a></li>
            </ul>
