...
$strSQL = "select a.title,a.id_newsinfo as id,b.lang,a.id_newsdir
		   ...
		   where a.dele=1 and b.lang=2 and b.fatherid='20'  order by a.ordernum desc limit $start,$setinfo[newsnum]" ;
