...
<div id="contentbox">
	  ...
	  #feedback .ui-body-a, .ui-overlay-a {color:#404040 /*{a-body-color}*/;background: transparent none;}
        ...
        <div id="feedback">
          ...
          <div class="feedbackline">Phone：&nbsp;&nbsp;&nbsp;&nbsp;<input id="tel" type="text" ></div>
          <div class="feedbackline">Email *：&nbsp;&nbsp;&nbsp;&nbsp;<input id="email" type="text"  ></div>
          <div class="feedbackline">Message *：&nbsp;&nbsp;&nbsp;&nbsp;<textarea id="content"  ></textarea></div>
          <div id="backmenu"><a onClick="sendmsg()"  href="javascript:void(0);">Send</a></div>
...
function sendmsg() {
						...
						if($.trim($("#email").val())=='' || !$("#email").val().match( /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/ )){alert('Please enter a valid email address');return false;}
						if($.trim($("#content").val())==''){alert('Please enter your message');return false;}	
						
						
						$.post('/en/about/ajax_feedback.php',{tel:$("#tel").val(),content:$("#content").val(),name:$("#name").val(),email:$("#email").val()},function(data) {
