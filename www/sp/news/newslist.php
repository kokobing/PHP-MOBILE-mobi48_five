<?php
require "../../inc/sp_newslist_core.php";
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="abouttop"><?=$onenewsdir[name]?></div>
            ...
            <?php for($i=0;$i<sizeof($arrnews);$i++){?>
				<li><a href="/sp/news/newsview.php/<?=$ndir?>/<?=$arrnews[$i][id]?>/.html"><?=$arrnews[$i][title]?></a></li>
            <?php }?>
			</ul>
            
            <ul data-role="listview" data-inset="true" data-theme="d" data-divider-theme="d" data-count-theme="b">
            <li><a href="javascript:void(0)"  onClick="spnextnews();">More <?=$onenewsdir[name]?></a></li>
            </ul>
