...
$strSQL = "select a.title,a.intro,a.id_prodinfo as pid,b.lang,b.fatherid,a.id_proddir from 
           productinfo as a left join productdir as b on a.id_proddir=b.id_proddir
		   where a.dele=1 and b.lang=3 and b.fatherid=$_REQUEST[pdir1]
		   order by a.ordernum desc limit $start,$setinfo[productnum]" ;	
}
...
$arr[info].='<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" data-iconpos="right" data-theme="d" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-thumb ui-btn-up-d"><div class="ui-btn-inner ui-li"><div class="ui-btn-text"><a href="/sp/product/productview.php/'.$arrproducts[$i][id_proddir].'/'.$arrproducts[$i][pid].'/.html" class="ui-link-inherit"><img src="/upload/product/'.$getpic.'" class="ui-li-thumb"><h2 class="ui-li-heading">'.$arrproducts[$i][title].'</h2><p class="ui-li-desc">'.$arrproducts[$i][intro].'</p></a></div><span class="ui-icon ui-icon-arrow-r ui-icon-shadow">&nbsp;</span></div></li>';
